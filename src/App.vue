...
const open = () => {
  ...
  createNotification({ title:"this is my button", message:"message is good", duration: 0, type: "info"})
...
onMounted(() => {
  createNotification({ title:"this is my notify", message:"message is good", duration: 0, type: "success"})
  createNotification({ title:"this is 2nd", message:"message is good", duration: 0, type: "danger"})
  createMessage({ message: 'hello world', duration: 0, showClose: true })
